				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Add a Founder </h2><span ><a href="<?= base_url('founder/view') ?>" class="btn btn-xs btn-danger pull-right" >Back</a></span>
								...
								<div class="x_content">
									...
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?= base_url('founder/store'); ?>" method="post" enctype="multipart/Form-data">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="subtitle" class="form-control" type="text" name="designation" >
											</div>
										</div>
										<div class="item form-group">
