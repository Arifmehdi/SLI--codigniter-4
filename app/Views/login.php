...
<script src="<?= base_url('login_asset/vendor/jquery/jquery-3.2.1.min.js')?>"></script>

<script src="<?= base_url('login_asset/vendor/animsition/js/animsition.min.js')?>"></script>

<script src="<?= base_url('login_asset/vendor/bootstrap/js/popper.js')?>"></script>
<script src="<?= base_url('login_asset/vendor/bootstrap/js/bootstrap.min.js')?>"></script>

<script src="<?= base_url('login_asset/vendor/select2/select2.min.js')?>"></script>

<script src="<?= base_url('login_asset/vendor/daterangepicker/moment.min.js')?>"></script>
<script src="<?= base_url('login_asset/vendor/daterangepicker/daterangepicker.js')?>"></script>

<script src="<?= base_url('login_asset/vendor/countdowntime/countdowntime.js')?>"></script>

<script src="<?= base_url('login_asset/js/main.js')?>"></script>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v652eace1692a40cfa3763df669d7439c1639079717194" integrity="sha512-Gi7xpJR8tSkrpF7aordPZQlW2DLtzUlZcumS8dMQjwDHEnw9I7ZLyiOj/6tZStRBGtGgN6ceN6cMH8z7etPGlw==" data-cf-beacon='{"rayId":"726aad312a1d4822","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2022.6.0","si":100}' crossorigin="anonymous"></script>
</body>
</html>
